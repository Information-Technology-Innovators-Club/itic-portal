...
function BackStat({
  ...
  return (
    <View style={styles.backStat}>
      ...
      <Text style={styles.backValue} numberOfLines={lines}>
        {value}
      </Text>
    </View>
  );
...
export function MemberIDCard({ user }: Props) {
  ...
  const theme =
    ROLE_THEME[user.role as keyof typeof ROLE_THEME] ?? ROLE_THEME.member;
        ...
        >
          ...
          >
            ...
            <View style={styles.circuitOverlay} pointerEvents="none">
              <View
                style={[styles.circuitLine, { top: 22, left: 110, width: 55 }]}
              />
              <View
                style={[
                  styles.circuitLine,
                  { top: 22, left: 110, width: 1.5, height: 36 },
                ]}
              />
              <View
                style={[
                  styles.circuitDot,
                  { top: 58, left: 109, backgroundColor: theme.accent + "60" },
                ]}
              />
              <View
                style={[
                  styles.circuitLine,
                  { bottom: 28, right: 90, width: 45 },
                ]}
              />
              <View
                style={[
                  styles.circuitLine,
                  { bottom: 28, right: 90, width: 1.5, height: 28 },
                ]}
              />
              <View
                style={[
            ...
            <View
              style={[
                styles.headerStrip,
                {
                  ...
                  borderBottomColor: theme.accent + "35",
                },
              ]}
            >
              <View
              ...
              <View
                style={[styles.rolePill, { backgroundColor: theme.accent }]}
              >
            ...
            <View style={styles.cardBody}>
              <View style={styles.cardLeft}>
                ...
                <View style={{ gap: 2, flex: 1 }}>
                  ...
                  <Text style={[styles.cardMemberId, { color: theme.accent }]}>
                    {user.memberId}
                  </Text>
                    ...
                    >
                      <Text
                        style={[
                          ...
                          {
                            color:
                              user.status === "active" ? "#86efac" : "#fcd34d",
                          },
                        ]}
                      >
              ...
              <View style={styles.qrContainer}>
                <View
                  style={[styles.qrOuter, { borderColor: theme.accent + "45" }]}
                >
                  <View
                    style={[
                      styles.qrInnerFrame,
                ...
                {/* Corner ticks */}
                <View
                  style={[styles.qrTickTL, { borderColor: theme.accent }]}
                />
                <View
                  style={[styles.qrTickTR, { borderColor: theme.accent }]}
                />
                <View
                  style={[styles.qrTickBL, { borderColor: theme.accent }]}
                />
                <View
                  style={[styles.qrTickBR, { borderColor: theme.accent }]}
                />
                <Text style={[styles.qrLabel, { color: theme.accent }]}>
                  SCAN ME
                </Text>
              </View>
            </View>
            ...
            <View
              style={[
                styles.bottomBar,
                { borderTopColor: theme.accent + "25" },
              ]}
            >
          ...
          >
            ...
            <View style={styles.backContent}>
              <View style={styles.backStatsRow}>
                ...
                <BackStat
                  icon="layers-outline"
                  label="LVL / SEM"
                  value={`${user.academicLevel} · ${user.semester}`}
                />
                <BackStat
              ...
              <View style={styles.backTagsSection}>
                ...
                <View style={styles.tagRow}>
                  ...
                  {user.technologyInterests.length === 0 && (
                    <Text style={[styles.interestText, { opacity: 0.55 }]}>
                      No interests listed
                    </Text>
                  )}
                </View>
            ...
            <View style={[styles.bottomBar, styles.backBottomBar]}>
              <Text style={styles.bottomTextLight}>
                Joined {user.joinedDate.split("T")[0]} · Property of ITIC
              </Text>
